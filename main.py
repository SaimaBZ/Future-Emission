...
API_KEY = "b0dffd751c8e45621822180be7426f1c"  # Replace with your actual API key
...
st.write("""
This project uses machine learning models trained on synthetic data to predict CO2, CO, and CH4 concentrations at different locations for the next 60 days.
